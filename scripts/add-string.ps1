#!/usr/bin/env pwsh
# Add one localized string key to ALL FOUR Strings resx files at once, so a new UI string is a single
# command instead of four hand edits. The satellites default to the English text as a placeholder (so the
